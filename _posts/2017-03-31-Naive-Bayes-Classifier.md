...
<br />
NBC는 1960 년대 초에 텍스트 마이닝 분야에 소개된 이후로 스팸 분류, 주제별 문서 분류 등에 광범위하게 이용되고 있다. 이 글에서는 NBC에 적용된 Bayes decision theory와 NBC의 설계 원리에 대해 소개하고, 간단한 주제별 문서 분류 예제를 통해 NBC의 학습 및 동작 원리를 설명할 것이다.
<br />
